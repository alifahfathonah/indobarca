		...
		<div id="container">
			...
			<div id="match">
				...
				<table align="center" border="0" style="border-collapse: collapse; font-family: monospace; color: white">
					<form enctype="multipart/form-data" method="post" action="<?php echo base_url(). "index.php/controller_barang/do_edit" ?>">
						...
						<tr>
							<td>KET. GAMBAR</td>
							<td>
								<textarea cols="23" rows="3" name="ket_gambar"><?php echo $ket_gambar; ?></textarea>
							</td>
						</tr>
