		...
		<div id="container">
			...
			<div id="match">
				...
				<table align="center" border="0" style="border-collapse: collapse; font-family: monospace; color: white">
					<form enctype="multipart/form-data" method="post" action="<?php echo base_url(). "index.php/controller_cabang/do_add" ?>">
						<tr>
							<td width="100">ID</td>
						...
						<tr>
							...
							<td><input type="text" name="nama_cabang" size="30"></td>
						</tr>

						<tr>
							<td width="100">NAMA ATASAN</td>
							<td><input type="text" name="nama_atasan" size="30"></td>
						</tr>
