...
<html>
	...
	<body bgcolor= #ebebeb>
		<div id="container">
			...
			<div id="match">
				<h2 style="font-family: sans-serif; text-align: center; color: yellow;">LIST INDOBARCA BARANG</h2>
				<table align="center" border="1" style="border-collapse: collapse; font-family: monospace;">
					<form>
						<tr bgcolor= "red" align="center">
							...
							<th width="60">FOTO</th>
							<th width="100">KET. GAMBAR</th>
							<th width="150">
								<a href="<?php echo base_url(). "index.php/controller_barang/add_data"; ?>">TAMBAH DATA</a>
							</th>
						</tr>
					<?php $i=1; foreach($data as $d){ ?>
						<tr bgcolor="white">
							...
							<td><?php echo $d['ket_gambar'] ?></td>
							<td align="center">
								<a href="<?php echo base_url(). "index.php/controller_barang/edit_data/".$d['id']; ?>">EDIT</a> ||
								<a href="<?php echo base_url(). "index.php/controller_barang/do_delete/".$d['id']; ?>">DELETE</a>
							</td>
						</tr>
					<?php $i++; } ?>
					</form>
